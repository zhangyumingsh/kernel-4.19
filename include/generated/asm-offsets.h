...
#define VCPU_CONTEXT 400 /* offsetof(struct kvm_vcpu, arch.ctxt) */
#define VCPU_FAULT_DISR 2120 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_WORKAROUND_FLAGS 2128 /* offsetof(struct kvm_vcpu, arch.workaround_flags) */
...
#define VCPU_FPEXC32_EL2 2048 /* offsetof(struct kvm_vcpu, arch.ctxt.sys_regs[FPEXC32_EL2]) */
#define VCPU_HOST_CONTEXT 3176 /* offsetof(struct kvm_vcpu, arch.host_cpu_context) */
