...
ifneq "$(KERNELVERSION)" "4.19.232"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "aarch64-linux-gnu-gcc (Ubuntu 11.3.0-1ubuntu1~22.04.1) 11.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "./scripts/gcc-wrapper.py ccache  aarch64-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "ccache  aarch64-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "ccache  aarch64-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "ccache  aarch64-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
